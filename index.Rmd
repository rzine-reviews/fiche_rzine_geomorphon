...
```{r, message=F, warning=F, echo=T, results='hide'}
noms = c("", "flat (plan)", "peak/summit (sommet)", "ridge (crête)", "shoulder (haut de versant", "spur (eperon)", "slope (pente)", "hollow (creux de versant)", "footslope (bas de versant)", "valley (fond de vallée)", "pit/depression (dépression)")
couleurs = c("#ffffffff",
             "#dcdcdc", 
             "#380000", 
             "#c80000", 
