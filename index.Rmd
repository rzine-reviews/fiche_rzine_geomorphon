...
```
library(sf)
bv <- st_read("BassinVersantTopographique.json") # chargement de la couche vecteur des bassins versants
bv <- bv %>% filter(bv$TopoOH == "Le Ribérot")   # sélection du bassin versant par son nom
plot(bv)                                         # affichage de l'emprise du bassin versant
