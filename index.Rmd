...
A partir du MNT, l'algorithme Geomorphon issu de qgisprocess nous permet d'obtenir la carte des géomorphons sur chacun des bassins versants. 
...
dem_geomorphons = qgis_run_algorithm("saga:geomorphons",
                                     ...
                                     RADIUS = 5,
                                     METHOD = 1,
                                     GEOMORPHONS = paste("geomorphon_nom_bv_5m_LD5", ".tif"))
